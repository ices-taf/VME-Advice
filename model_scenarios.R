...
## Scenario C
vme.scenario.c.csquares <- vme_scenario_C(vme_data, sar_layer, 0.44)

## Scenario D
vme.scenario.d.csquares <- vme_scenario_D(vme_data, sar_layer, 0.44)

## Scenario E
vme.scenario.e.csquares <- vme_scenario_E(vme_data, vme_elements, sar_layer, 0.44)
