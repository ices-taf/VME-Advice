...
# names for the leaflet
  nam <- c("Ecoregion boundaries","EEZ boundaries","Depth zone 400-800m",
           "Existing VME C-sq.","New/updated VME C-sq.","EU fishable domain", "Fished area (S+M)","Reference fished area (S)","Fished area (S)",
